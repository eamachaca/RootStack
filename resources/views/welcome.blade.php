...
<div
    ...
    @if (Route::has('login'))
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a class="text-sm text-gray-700 dark:text-gray-500 underline" href="{{ route('database') }}">{{ __('Reset Database') }}</a>
                &nbsp&nbsp&nbsp
                <a class="text-sm text-gray-700 dark:text-gray-500 underline" href="{{ route('queue.categories') }}">{{ __('Update Categories') }}</a>
                &nbsp&nbsp&nbsp
                <a class="text-sm text-gray-700 dark:text-gray-500 underline" href="{{ route('queue.products') }}">{{ __('Update Products') }}</a>
                &nbsp&nbsp&nbsp
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            You have to register to see the enabled routes
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">Update Categories</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            With this path, you can execute a scraper to get all categories from <a
                                href="https://www.milanuncios.com/">MilAnuncios</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">Update Products</div>
                    </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">About Updates</div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            Any Update uses queued job to make the scrap
                        </div>
                    </div>
                </div>
            </div>
